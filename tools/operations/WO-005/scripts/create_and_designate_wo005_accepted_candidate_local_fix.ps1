...
$candidateWorktree = "$env:USERPROFILE\Projects\aegis-platform-wo-005-accepted-candidate-local-fix"
...
$reviewWorktree = "$env:USERPROFILE\Projects\aegis-platform-wo-005-candidate-review-local-fix"
$reviewBranch = "governance/wo-005-accepted-candidate-designation-local-fix"
