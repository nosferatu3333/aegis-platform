...
$worktree = "$env:USERPROFILE\Projects\aegis-platform-wo-005-amendment"
$branch = "governance/wo-005-preexisting-specification-amendment"
...
'@
    ...
    foreach ($requiredText in @(
        ...
        "Amendment 001 - Pre-existing specification correction",
        "does not authorize replacement with an unrelated document"
    )) {
